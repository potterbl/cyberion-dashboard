...
const DivisionsEdit = () => {
    ...
    const [showToggle, setShowToggle] = React.useState("");

    const fetchTournament = async () => {
        await api
            .get(`tournaments/division/${id}`)
            .then((res) => {
    ...
    const handleSave = async () => {
        ...
        await api
            .put(`/tournaments/division${id}`, formData, {
                headers: {
    ...
    const divisions = [
        { value: '1', label: '1 дівізіон'},
        { value: '2', label: '2 дівізіон'},
    ]
                        ...
                        activePage === 0 ?
                            (
                                <>
                                    ...
                                    <div className="users-create_body-label">
                                        <p>Дівізіон</p>
                                        <Select options={divisions} onChange={(v) => setDivision(v.value)} className="users-create_body-label_input-select"/>
                                    </div>
                                    <div className="users-create_body-label">
