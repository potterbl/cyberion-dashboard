...
const BlogEdit = () => {
    ...
    const fetchBlog = async () => {
        await axios
            .get(`https://api.cyberion.com.ua/blog/${id}`)
            .then((res) => {
    ...
    const handleSave = async () => {
        ...
        await axios
            .put(`https://api.cyberion.com.ua/blog/${id}`, formdata, {
                headers: {
    ...
    const handleDelete = async () => {
        await axios
            .delete(`https://api.cyberion.com.ua/blog/${id}`, {
                headers: {
                    'Content-Type': 'multipart/form-data',
                    'authorization': localStorage.getItem('token')
                }
        ...
        <>
            ...
            <div className="blog-edit">
                ...
                <div className="blog-edit_footer">
                    ...
                    <button className="blog-edit_footer-btn blog-edit_footer-btn_delete" onClick={handleDelete}>
                        Видалити
                    </button>
                </div>
            </div>
